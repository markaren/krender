...
class CatmullRomCurve3(
    ...
    override fun getPoint(t: Double): Vector3d {
        ...
        if (type == null || type == Type.CENTRIPETAL || type == Type.CHORDAL) {
            ...
            val pow = if (type == Type.CHORDAL) 0.5 else 0.25
            ...
            tension = if (tension != null) tension else 0.5
    ...
    class CubicPoly {
        ...
        fun init(x0: Double, x1: Double, t0: Double, t1: Double) {
            c0 = x0
            c1 = t0
         ...
         */
        fun initCatmullRom(x0: Double, x1: Double, x2: Double, x3: Double, tension: Double) {
